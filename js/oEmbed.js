...
(function() {
  ...
  oEmbed.parametersForNode = function(node) {
    var attributes, match, name, value, _i, _len, _ref1, _ref2;
    attributes = {};
  ...
  oEmbed.embed = function(embed, config) {
    var attributes, error, host, k, parameters, provider, requestURL, success, v, _ref1;
    if (config == null) {
      config = {};
    }
    ...
    success = function(result) {
      ...
      embed.classList.add(result != null ? result.provider_name.toLowerCase().replace(/\s+/, '-') : void 0);
